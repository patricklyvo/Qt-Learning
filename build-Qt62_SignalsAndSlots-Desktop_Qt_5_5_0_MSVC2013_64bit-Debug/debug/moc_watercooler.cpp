...
#include "../../Qt62_SignalsAndSlots/watercooler.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WaterCooler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WaterCooler_t qt_meta_stringdata_WaterCooler = {
    {
QT_MOC_LITERAL(0, 0, 11) // "WaterCooler"
...
const QMetaObject WaterCooler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WaterCooler.data,
      qt_meta_data_WaterCooler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WaterCooler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WaterCooler.stringdata0))
